...
export class RedesSociaisComponent implements OnInit {
  ...
  private carregarRedesSociais(id: number = 0): void {
    ...
    if(funcao == 'Palestrante') {
      if (this.eventoId !== 0) funcao = 'evento';
      ...
      this.redeSocialService
        ...
        .subscribe(
          (redeSocialRetorno: RedeSocial[]) => {
            if (redeSocialRetorno.length == 0) {
              this.toastr.info('Adicione seu Minicurrículo e suas Redes Sociais', 'Modo Palestrante Habilitado');
            }
